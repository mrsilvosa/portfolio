...
color(Couleur1){ 
     difference(){
                Coque();
                SquareHole(1,Length-60-17-63-10,(Width-20)/2,20,20,1);;
            }
}
    ...
    translate([0,Width,Height+0.2]){
        rotate([0,180,180])
        {
            difference(){
                ...
                SquareHole(1,8,(Width-62)/2,43,62,1);
                CylinderHole(1,8+3+36.72,(Width/2)-33.63,3);
                CylinderHole(1,8+3,(Width/2)-33.63,3);
                CylinderHole(1,8+3+36.72,(Width/2)+33.63,3);
                CylinderHole(1,8+3,(Width/2)+33.63,3);;
                
                
                CylinderHole(1,Length-60-17-63,Width/2-43,4);
                CylinderHole(1,Length-60-17-63,Width/2+43,4);
                CylinderHole(1,Length-60-17-63+95,Width/2-43,4);

                
                
                CylinderHole(1,Length-60-17,Width/2,10);
                CylinderHole(1,Length-60,Width/2,10);
                CylinderHole(1,Length-60-17-17,Width/2,10);
                CylinderHole(1,Length-60-17,Width/2+17,10);
                CylinderHole(1,Length-60-17,Width/2-17,10);
                
                translate([-30,5,-5 ]){
                SquareHole(1,Length-60-17-63+80+30,-10,10,10,1);
                }
